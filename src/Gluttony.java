...
public class Gluttony extends Character{

	ImageView portrait = new ImageView(new Image ("portraits/glutoPortrait.jpg"));
	...
	String move2 = "";
	String move3 = "";
	String move1desc = "Does 20 damage and heals 15 hp";
	String move2desc = "";
	String move3desc = "";
	...
	public Timeline atk1(Character user, Character enemy, Label log, Stage ps)
	{
		...
		KeyFrame first = new KeyFrame(Duration.ZERO, ae -> log.setText(user.getName() + " took a bite out of " + enemy.getName() + " for " + dmg + " dmg!"));
